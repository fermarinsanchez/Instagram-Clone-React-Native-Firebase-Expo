import { USER_STATE_CHANGE, USERS_POSTS_STATE_CHANGE, USER_POSTS_STATE_CHANGE, USER_FOLLOWING_STATE_CHANGE, USERS_DATA_STATE_CHANGE, CLEAR_DATA, USERS_LIKE_STATE_CHANGE } from '../constants/index'
    ...
    return ((dispatch, getState) => {
        firebase.firestore()
            ...
            .onSnapshot((snapshot) => {
                ...
                const postId = snapshot.d_.S_.path.segments[3];
